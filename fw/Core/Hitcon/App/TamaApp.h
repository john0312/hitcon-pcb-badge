...
static constexpr auto& TAMA_HEAL_CONFIRM_FRAMES = TAMA_HOSPITAL_ICONS;
...
constexpr tama_ani_t animation[] = {
    ...
    {.type = TAMA_ANIMATION_TYPE::HEAL_CONFIRM,
     .frame_count = 1,
     .length = 8,
     .frames_data = TAMA_HEAL_CONFIRM_FRAMES},
};
...
ASSERT_ANIMATION_PROPERTIES(HEAL_CONFIRM);
