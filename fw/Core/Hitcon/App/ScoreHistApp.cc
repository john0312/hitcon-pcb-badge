...
char spaceship_score_str[15] = "Spaceship ";
...
void ScoreHistApp::SetScores() {
  ...
  int spaceship_score = g_game_score.GetScore(GameScoreType::GAME_SPACESHIP);
  ...
  if (spaceship_score > 9999999) spaceship_score = 9999999;
  ...
  uint_to_chr(&spaceship_score_str[9], 8, spaceship_score);
