...
class CircularQueue
{
 private:
  ...
  // This generally points to an empty/invalid element as this position is where the next pushed item will be inserted.
  size_t m_back_;
